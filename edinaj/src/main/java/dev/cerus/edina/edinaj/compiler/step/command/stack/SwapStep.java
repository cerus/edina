...
public class SwapStep implements CompilerStep<StepData<Command.SwapCommand>> {

    @Override
    public void compile(final ClassWriter cw, final CompilerSettings settings, final StepData<Command.SwapCommand> obj) {
        ...
        methodVisitor.visitMethodInsn(INVOKEVIRTUAL, settings.getStackName(), "swap", "()V", false);
    }
