...
methodVisitor.visitLocalVariable("e", "Ljava/io/IOException;", null, label8, label7, 4);
methodVisitor.visitLocalVariable("args", "[Ljava/lang/String;", null, label3, label9, 0);
methodVisitor.visitLocalVariable("stack", "L" + settings.getStackName() + ";", null, label4, label9, 1);
methodVisitor.visitLocalVariable("natives", "L" + settings.getNativesName() + ";", null, label5, label9, 2);
methodVisitor.visitLocalVariable("app", "L" + settings.getAppName() + ";", null, label6, label9, 3);
